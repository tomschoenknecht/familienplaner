...
const artikel = [
  {
    ...
    einleitung: 'Wer sich hinsetzt und sieben Gerichte aus dem Nichts erfinden will, stellt sich eine Aufgabe, an der jeder scheitert. Ein guter Wochenplan wird nicht erfunden, er wird zusammengesetzt – aus wenigen festen Bausteinen, die sich jede Woche wiederholen dürfen.',
    abschnitte: [
  ...
  },
  {
    ...
    einleitung: 'Wer diese Frage in eine Suchmaschine tippt, bekommt tausend Vorschläge und ist danach ratloser als vorher. Der Grund ist einfach: Das Problem ist nicht Mangel, sondern Überfluss. Jede zusätzliche Option macht die Entscheidung teurer.',
    abschnitte: [
      ...
      { h: 'Wiederholung ist kein Makel', p: ['Familien mögen Wiederholung mehr, als Kochblogs zugeben. Kinder essen lieber, was sie kennen, und du kochst schneller, was du auswendig kannst. Ein Gericht alle zwei Wochen ist keine Eintönigkeit, sondern Verlässlichkeit.', 'Abwechslung entsteht besser über Beilagen und Saucen als über ständig neue Rezepte. Dieselben Nudeln mit vier Saucen sind vier Gerichte.'] },
  ...
  },
  {
    ...
    einleitung: 'Die Einkaufsliste ist kein eigenständiges Dokument, sondern das Ergebnis des Wochenplans. Diese Reihenfolge klingt banal und wird trotzdem ständig umgedreht – mit dem Ergebnis, dass drei Sorten Joghurt im Kühlschrank stehen und für Mittwoch nichts da ist.',
    abschnitte: [
  ...
  },
  {
    ...
    einleitung: 'Zwischen dem zweiten und dem sechsten Lebensjahr lehnen die meisten Kinder Unbekanntes reflexhaft ab. Das ist biologisch sinnvoll gewesen, als kleine Menschen selbst durch die Gegend liefen und Beeren fanden. Am Familientisch ist es vor allem anstrengend – und es geht vorbei, wenn man es nicht zum Machtkampf macht.',
    abschnitte: [
  ...
  },
  {
    ...
    lead: 'Um sieben Uhr morgens ist niemand kreativ. Deshalb braucht die Brotdose kein Rezept, sondern ein Muster.',
    einleitung: 'Wer jeden Morgen neu überlegt, landet nach zwei Wochen wieder beim Käsebrot – und beim schlechten Gewissen. Ein Baukasten löst das, weil er die Entscheidung von der Uhrzeit trennt, zu der sie getroffen werden muss.',
    abschnitte: [
  ...
  },
  {
    ...
    einleitung: 'Meal Prep hat ein Bildproblem: gestapelte Behälter mit fünfmal demselben Reisgericht. In einer Familie isst am Dienstag jemand auswärts, am Mittwoch kommt ein Kind früher, und am Donnerstag will niemand mehr Reis sehen. Was trägt, ist ein anderer Zuschnitt.',
    abschnitte: [
